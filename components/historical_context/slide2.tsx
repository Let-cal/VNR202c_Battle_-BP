                    ...
                    <div className="absolute bottom-0 right-0 w-[90%] p-6 bg-gradient-to-t  via-transparent to-transparent">
                        <div className="text-white text-lg font-light bg-[#BC6A34]/80 bg-opacity-70 p-6 rounded-md mt-4 ">
                            ...
                            <ul className=" space-y-2 text-white text-3xl">
                                <li>
                                    Thực dân Pháp và can thiệp Mỹ đã cho ra đời
                                    Kế hoạch Nava
                                </li>
                            </ul>
                        </div>
                ...
                <div className="w-1/2 h-full flex flex-col justify-center px-12 space-y-8 bg-gradient-to-t from-black via-transparent to-transparent p-8">
                    ...
                    <div className="text-[#F7BB03] text-lg font-light bg-[#BC6A34]/60 bg-opacity-70 p-6 rounded-md mt-4 space-y-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-white">
                            <li>
                                Tăng viện lớn về binh lực và chi phí chiến tranh
                                Pháp và Mỹ lập kế hoạch đến năm 1954 quân chủ
                                lực Pháp có 7 sư đoàn cơ động chiến lược với 27
                                binh đoàn làm nắm đấm thép
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="text-[#F7BB03] text-lg font-light bg-[#BC6A34]/60 bg-opacity-70 p-6 rounded-md mt-4 space-y-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-white">
                            <li>
                                Sẽ tiêu diệt phần lớn bộ đội chủ lực của ta,
                                kiểm soát lãnh thổ Việt Nam và bình định cả Nam
                                Đông Dương.
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="text-[#F7BB03] text-lg font-light bg-[#BC6A34]/60 bg-opacity-70 p-6 rounded-md mt-4 space-y-4">
                        <div className="font-bold text-xl">
                            LÀ NỖ LỰC CUỐI CÙNG CỦA THỰC DÂN PHÁP VÀ CAN THIỆP
                            MỸ
                        </div>
                        <ul className="list-disc pl-6 space-y-2 text-white">
                            <li>
                                Nhằm giành lại thế chủ động có tính quyết định
                                về quân sự trên chiến trường làm cơ sở cho một
                                giải pháp chính trị có lợi cho chúng
                            </li>
                        </ul>
                    </div>
                </div>
