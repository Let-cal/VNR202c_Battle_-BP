...
import SlidePage1 from "./fightQuick";
import SlidePage2 from "./fightCarefully";
import SlidePage3 from "./whyFightCarefully";
import SlidePage4 from "./armyArt";
  ...
  return (
    ...
    >
      <div className="sticky top-0 w-full h-full">
        <AnimatePresence key={"context"} initial={false} custom={direction}>
          {slides.map(
            (slide, index) =>
              currentSlide === index && (
                <motion.div
